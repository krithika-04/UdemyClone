...
module.exports = app => {
    ...
    router.get("/lesson/:id/:l_id",upload.single('course_video'),requireSignin,isInstructor, lessons.fetchSingleLesson);
    router.put("/updateLesson/:id/:l_id",upload.single('course_video'),requireSignin,isInstructor,lessons.updateLesson)
